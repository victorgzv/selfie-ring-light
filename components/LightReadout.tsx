 ...
 */
function LightReadoutImpl({ dial, temperatureLabel, kelvin, accent, lightOn }: Props) {
  ...
  return (
    <Animated.View style={style} className="flex-row items-center justify-center gap-2">
      ...
      <Text className="text-[13px] font-medium text-white/55">
        {temperatureLabel} {kelvin}K
      </Text>
    </Animated.View>
  );
}
